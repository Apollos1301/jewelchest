...
def amaz_damen():
    ...
    for link in products:
        ...
        productID += 1
        #print(productInfo[counter].price +" ====>   "+ productInfo[counter].link)
        print(" ")
        print(" ")
        counter += 1
amaz_damen()
